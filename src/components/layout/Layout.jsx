...
const MENU = [
  ...
  },
  {
    ...
    label: 'Mascotas',
    icono: '🐾',
    roles: ['CLIENTE', 'GROOMER', 'ADMINISTRADOR']
  },
  {
    path: '/citas',
    label: 'Citas',
  ...
  },
  {
    ...
    label: 'Personal',
    icono: '👑',
    roles: ['ADMINISTRADOR']   // ← solo el admin ve este ítem
  },
  {
    path: '/admin/logs',
    label: 'Logs',
  ...
  },
  {
    ...
    label: 'Calendario',
    icono: '🗓️',
    roles: ['ADMINISTRADOR', 'CAJERO', 'GROOMER']
  },
]
      ...
      <aside style={estilos.sidebar}>
        ...
        <div style={estilos.usuarioCard}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <span style={{
              ...estilos.usuarioRol,
              background: coloresRol.bg,
              color: coloresRol.color
            }}>
              {perfil?.rol}
            </span>
          </div>
